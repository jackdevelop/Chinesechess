...
class CC_DLL ChinesechessPlayer : public CCObject
{
public:
...
private:
    static ChinesechessPlayer *s_sharedInstance;
    static ChinesechessPlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    ChinesechessPlayer(void);
