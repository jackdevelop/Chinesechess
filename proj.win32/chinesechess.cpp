    ...
    int       nCmdShow)
{
    ...
    return ChinesechessPlayer::createAndRun();
}

int ChinesechessPlayer::createAndRun(void)
{
    ChinesechessPlayer *host = ChinesechessPlayer::sharedInstance();
    int ret = host->run();
    ChinesechessPlayer::purgeSharedInstance();
    return ret;
}

ChinesechessPlayer *ChinesechessPlayer::s_sharedInstance = NULL;

ChinesechessPlayer *ChinesechessPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new ChinesechessPlayer();
    }
    return s_sharedInstance;
}

void ChinesechessPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
ChinesechessPlayer::ChinesechessPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int ChinesechessPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "chinesechess-player");
...
void ChinesechessPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void ChinesechessPlayer::createViewMenu(void)
{
...
void ChinesechessPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void ChinesechessPlayer::updateWindowTitle(void)
{
}

void ChinesechessPlayer::relaunch(void)
{
...
void ChinesechessPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void ChinesechessPlayer::onFileOpenProject(void)
{
...
void ChinesechessPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"ChinesechessPlayer");
...
void ChinesechessPlayer::onFileProjectConfig(void)
{
...
void ChinesechessPlayer::onFileRelaunch(void)
{
    relaunch();
}

void ChinesechessPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void ChinesechessPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void ChinesechessPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void ChinesechessPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void ChinesechessPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT ChinesechessPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    ChinesechessPlayer *host = ChinesechessPlayer::sharedInstance();
...
INT_PTR CALLBACK ChinesechessPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
